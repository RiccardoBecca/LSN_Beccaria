...
void Input(void){ //Prepare all stuff for the simulation
  ...
  ReadInput.open("input."+phase); //Read input
...
void Measure(){ //Properties measurement
  ...
  Epot.open("./"+phase+"_phase/output_epot_"+phase+".dat",ios::app);
  Ekin.open("./"+phase+"_phase/output_ekin_"+phase+".dat",ios::app);
  Temp.open("./"+phase+"_phase/output_temp_"+phase+".dat",ios::app);
  Etot.open("./"+phase+"_phase/output_etot_"+phase+".dat",ios::app);
...
//Kinetic energy
  for (int i=0; i<npart; ++i) t += 0.5 * (vx[i]*vx[i] + vy[i]*vy[i] + vz[i]*vz[i]);
    ...
    if(start_measure != 1){
        ofstream Equi;
        Equi.open("./"+phase+"_phase/equilibration_"+phase+".dat",ios::app);
...
void Averages(int iblk) //Print results for current block
{
   ...
   ofstream Pot_ave, Kin_ave, Temp_ave, Etot_ave, Gofr, Gave;
    ...
    Pot_ave.open("./"+phase+"_phase/ave_epot_"+phase+".out",ios::app);
    ...
    Kin_ave.open("./"+phase+"_phase/ave_kin_"+phase+".out",ios::app);
    ...
    Temp_ave.open("./"+phase+"_phase/ave_temp_"+phase+".out",ios::app);
...
//    cout <<glob_av[it] << " "<< err_temp << " " << iblk << " "<< glob_av2[it] << endl;
    ...
    Etot_ave.open("./"+phase+"_phase/ave_etot_"+phase+".out",ios::app);
