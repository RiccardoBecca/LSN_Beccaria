...
{
	return 1.0;
//    return exp(-pow((v-0.795),2)/(2*0.617*0.617) )+ exp(-pow((v+0.795),2)/(2*0.617*0.617));
}

double variationalWaveFunction_second(double v)
{
	return 0;
//    return -(exp(-pow(v-0.795,2)/(2*0.617*0.617)) + exp(-pow(v+0.795,2)/(2*0.617*0.617)) )/(0.617*0.617) +( pow(v-0.795,2)*exp(-pow(v-0.795,2)/(2*0.617*0.617)) +pow(v+0.795,2)*exp(-pow(v+0.795,2)/(2*0.617*0.617)) )/(pow(0.617,4));
}
